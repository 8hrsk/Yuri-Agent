...
describe('ChatHeader conversation title editor', () => {
  it('renders the active agent affect and gives it to the avatar instead of using the default mood', () => {
    render(<ChatHeader {...props} model="openrouter/free" providerId="openrouter" affect={{
    ...
    expect(screen.getByLabelText('Модель агента: openrouter · openrouter/free')).toBeInTheDocument()
