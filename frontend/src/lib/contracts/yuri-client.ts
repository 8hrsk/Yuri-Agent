...
export interface YuriClient {
  ...
  updateActiveAgentExecutionBudget(preset: import('./agents').ExecutionBudgetPreset): Promise<AgentProfile>
  ...
  recommendPeerDialogueBudget(peerAgentId: string, purpose: string): Promise<PeerDialogueBudgetRecommendation>
