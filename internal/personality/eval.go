...
var behavioralScenarioQualitySignals = map[string][][]string{
	...
	"disagreement":    {{"не соглаш", "не соглас", "не совсем соглас", "не могу соглас", "не могу просто соглас", "не могу с этим соглас", "возраж", "иначе"}, {"потому", "риск", "ошиб", "регресс", "слом", "баг"}},
	"self_correction": {{"извин", "прости", "ошиб", "невер", "пошло не так"}, {"исправ", "провер", "верн"}},
	"praise":          {{"спасибо", "пожалуйста", "приятно", "рада", "цен"}},
	"peer_praise":     {{"агент", "коллег", "они", "он", "она", "него", "его", "лучше"}},
	"fear":            {{"безопас", "проверь", "проверьте", "выйди", "позвони", "рядом", "глазок", "прислуш", "электрик"}},
	"reconciliation":  {{"спокой", "помир", "услыш", "слышу", "обсуд", "давай", "прин", "погоряч", "согласна", "мир"}},
}
