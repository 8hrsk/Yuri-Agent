...
func portableCreateAgentInput(profile domain.AgentProfile, seed domain.PersonalizationSeed) CreateAgentInput {
	...
	return CreateAgentInput{Name: profile.Name, Age: profile.Age, Gender: profile.Gender, Preferences: seed.Identity.SelfDescription, Backstory: seed.Backstory.Narrative, Traits: seed.Temperament.Traits(), Personalization: &CreateAgentPersonalizationInput{
